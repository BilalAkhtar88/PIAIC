...
export function welcome(attempts:number) {
...
export async function startGame(maxAttempts:number, a:number, b:number) {

    let attempts:number = 1;
    // let score:number = 0;

    function genRanNum(a:number, b:number):number {
